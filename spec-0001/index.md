...
A pip-installable implementation of the lazy loader lives at https://github.com/scientific-python/lazy_loader.

We are still very interested in suggestions and comments from the community. The prototype implementation has been adapted for use in [scikit-image](https://github.com/scikit-image/scikit-image/pull/5101), [napari](https://github.com/napari/napari/pull/2816), and [NetworkX](https://github.com/networkx/networkx/pull/4909).
